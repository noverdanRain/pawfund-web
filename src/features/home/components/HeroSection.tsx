...
const HeroSection = () => {
	return (
		<>
			<section className="relative mt-4 flex h-[calc(100svh-4rem)] max-h-[760px] min-h-[600px] flex-col items-center justify-between gap-4 overflow-clip rounded-[40px] bg-gray-100 px-8 py-20 sm:max-h-[672px]">
