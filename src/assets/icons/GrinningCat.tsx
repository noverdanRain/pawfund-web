...
export function FluentEmojiFlatGrinningCatWithSmilingEyes(props: SVGProps<SVGSVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32" {...props}>
			...
			<g fill="none">
				...
				<path
					fill="#402A32"
					d="M11 19.5c0-.17.055-.436.206-.645c.132-.184.357-.355.794-.355s.662.17.794.355c.15.209.206.475.206.645a.5.5 0 0 0 1 0c0-.33-.095-.814-.394-1.23c-.318-.44-.843-.77-1.606-.77s-1.288.33-1.606.77c-.3.416-.394.9-.394 1.23a.5.5 0 0 0 1 0m8 0c0-.17.055-.436.206-.645c.132-.184.357-.355.794-.355s.662.17.794.355c.15.209.206.475.206.645a.5.5 0 0 0 1 0c0-.33-.095-.814-.394-1.23c-.318-.44-.843-.77-1.606-.77s-1.288.33-1.606.77c-.3.416-.394.9-.394 1.23a.5.5 0 0 0 1 0"
				/>
			</g>
		</svg>
	);
